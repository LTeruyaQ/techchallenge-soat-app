...
public class ObterOrdensServicoAtivasComIncludeEspecificacao : EspecificacaoBase<OrdemServicoEntityDto>
{
    public ObterOrdensServicoAtivasComIncludeEspecificacao()
    {
    ...
    public override Expression<Func<OrdemServicoEntityDto, bool>> Expressao =>
        os => os.Status != StatusOrdemServico.Finalizada
